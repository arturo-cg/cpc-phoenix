...
namespace CPC {
    ...
    **
    */
    const CMemoryBlock* CGateArray::GetVisibleReadMemoryBlock(unsigned block) const
    {
        return (block < 4 ? m_apVisibleReadBlocks[block] : nullptr);
    }
    ...
    **
    */
    const CMemoryBlock* CGateArray::GetVisibleWriteMemoryBlock(unsigned block) const
    {
        return (block < 4 ? m_apVisibleWriteBlocks[block] : nullptr);
    }
    ...
    */
    void CGateArray::GeneratePhysicalPixels()
    {
        ...
        if (pCrtc->GetDisplayEnabledState())
        {
            ...
            const CCrtc::SGeneratedAddress& crtcAddress = pCrtc->GetCurrentAddress();
            ...
            cpcWord videoWord = (ramBlock->ReadByte(ramAddress) << 8) | ramBlock->ReadByte(ramAddress + 1); // Bits 13-0 of the address are the offset into the selected RAM block.
    ...
    void CGateArray::GeneratePhysicalPixels_Mode0(cpcWord videoWord)
    {
        ...
        m_aPhysicalPixels[0] = m_aPhysicalPixels[1] = m_aPhysicalPixels[2] = m_aPhysicalPixels[3] = GetPenRgb(((videoWord & 0x0200) >> 6) | ((videoWord & 0x2000) >> 11) | ((videoWord & 0x0800) >> 10) | ((videoWord & 0x8000) >> 15));
        m_aPhysicalPixels[4] = m_aPhysicalPixels[5] = m_aPhysicalPixels[6] = m_aPhysicalPixels[7] = GetPenRgb(((videoWord & 0x0100) >> 5) | ((videoWord & 0x1000) >> 10) | ((videoWord & 0x0400) >> 9) | ((videoWord & 0x4000) >> 14));
        m_aPhysicalPixels[8] = m_aPhysicalPixels[9] = m_aPhysicalPixels[10] = m_aPhysicalPixels[11] = GetPenRgb(((videoWord & 0x0002) << 2) | ((videoWord & 0x0020) >> 3) | ((videoWord & 0x0008) >> 2) | ((videoWord & 0x0080) >> 7));
        m_aPhysicalPixels[12] = m_aPhysicalPixels[13] = m_aPhysicalPixels[14] = m_aPhysicalPixels[15] = GetPenRgb(((videoWord & 0x0001) << 3) | ((videoWord & 0x0010) >> 2) | ((videoWord & 0x0004) >> 1) | ((videoWord & 0x0040) >> 6));
    }
    ...
    void CGateArray::GeneratePhysicalPixels_Mode1(cpcWord videoWord)
    {
        ...
        m_aPhysicalPixels[0] = m_aPhysicalPixels[1] = GetPenRgb(((videoWord & 0x0800) >> 10) | ((videoWord & 0x8000) >> 15));
        m_aPhysicalPixels[2] = m_aPhysicalPixels[3] = GetPenRgb(((videoWord & 0x0400) >> 9) | ((videoWord & 0x4000) >> 14));
        m_aPhysicalPixels[4] = m_aPhysicalPixels[5] = GetPenRgb(((videoWord & 0x0200) >> 8) | ((videoWord & 0x2000) >> 13));
        m_aPhysicalPixels[6] = m_aPhysicalPixels[7] = GetPenRgb(((videoWord & 0x0100) >> 7) | ((videoWord & 0x1000) >> 12));
        m_aPhysicalPixels[8] = m_aPhysicalPixels[9] = GetPenRgb(((videoWord & 0x0008) >> 2) | ((videoWord & 0x0080) >> 7));
        m_aPhysicalPixels[10] = m_aPhysicalPixels[11] = GetPenRgb(((videoWord & 0x0004) >> 1) | ((videoWord & 0x0040) >> 6));
        m_aPhysicalPixels[12] = m_aPhysicalPixels[13] = GetPenRgb(((videoWord & 0x0002)) | ((videoWord & 0x0020) >> 5));
        m_aPhysicalPixels[14] = m_aPhysicalPixels[15] = GetPenRgb(((videoWord & 0x0001) << 1) | ((videoWord & 0x0010) >> 4));
    }
