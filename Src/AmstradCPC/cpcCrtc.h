    ...
    */
    ...
    public:
        ...
        enum ERegister
        {
            ...
            CURSOR_START_RASTER = 10,       // These 5-bit registers select the starting and ending scan lines for the cursor. In addition, bits 5 and 6 of R10 are used to select the cursor mode, as follows: (see UM6845 datasheet).
        ...
        *** On the CPC, the Gate-Array uses it to generate video signal. If enabled, it reads pixel data from RAM. Otherwise, it uses the border color. */
        ...
        /** Returns the current value of the Horizontal Character Counter (a.k.a. HCC or C0). */
        cpcByte                 GetCurrentHCharacter() const { return m_nCurrentHCharacter; }
        /** Returns the current value of the Vertical Character Counter (a.k.a. VCC or C4). */
        cpcByte                 GetCurrentVCharacter() const { return m_nCurrentVCharacter; }
        /** Returns the current value of the Vertical Scan Line Counter (a.k.a. VLC or C9). */
        cpcByte                 GetCurrentScanLine() const { return m_nCurrentScanLine; }
