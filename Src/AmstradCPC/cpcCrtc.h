...
namespace CPC {
  ...
  */
  ...
  public:
    ...
    unsigned                GetFrameCount             () const  { return m_uMonitorFrameCount; }
    ...
    /** Returns the table of addresses generated by the CRTC at the start of each scan line for a complete frame using current register values. */
    const SGeneratedAddress* GetGeneratedAddressTable () const;
  ...
  private:
    ...
    void                    ComputeGeneratedAddressTable ();
    ...
    unsigned                m_uMonitorFrameCount;

    /** The addresses generated by the CRTC at the start of each scan line for a complete frame using current register values. */
    SGeneratedAddress       m_aGeneratedAddressTable[MAX_SCAN_LINE_COUNT];
    bool                    m_bGeneratedAddressTableUpToDate;
