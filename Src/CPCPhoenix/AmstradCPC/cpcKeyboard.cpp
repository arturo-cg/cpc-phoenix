...
namespace CPC {
  ...
  /*static*/ const ECpcKey CKeyboard::s_aeKeyboardMatrix[CKeyboard::KEYS_PER_LINE][CKeyboard::LINE_COUNT] = {
    ...
    /*Bit 7*/ CPCKEY_NUM_PERIOD,   CPCKEY_NUM_0,       CPCKEY_CTRL,           CPCKEY_COMMA,     CPCKEY_PERIOD, CPCKEY_SPACE, CPCKEY_V, CPCKEY_X, CPCKEY_Z,         CPCKEY_DEL,
  };
  ...
  */
  ...
  {
    GetMachine()->GetPsg()->SetRegisterValue( CPsg::IO_PORT_A_REGISTER, GetSelectedLineStatus() );
  }
